...
pub const PREDEFINED_PERMISSIONS: &[PredefinedPermission] = &[
    ...
    PredefinedPermission("user-public", "read", "Read User Public", "Read the public information of a user via GET /api/public-users/:id"),
    PredefinedPermission("user-public", "list", "List User Public", "List all the users matching criteria with public information via GET /api/public-users"),
    ...
    PredefinedPermission("token", "revoke", "Revoke Token", "Revoke all the tokens via DELETE /api/tokens"),
    PredefinedPermission("token", "revoke-self", "Revoke Self Token", "Revoke all user's own tokens via DELETE /api/my-tokens"),
    PredefinedPermission("token", "list", "List Token", "List all the tokens via GET /api/tokens"),
    PredefinedPermission("token", "list-self", "List Self Token", "List all user's own tokens tokens via GET /api/my-tokens"),
    PredefinedPermission("token", "read-single", "Read Single Token", "Read the information of a token via GET /api/tokens/:jti"),
    PredefinedPermission("token", "revoke-single", "Revoke Single Token", "Revoke one token belong to a user via DELETE /api/tokens/:jti"),
    PredefinedPermission("token", "read-single-self", "Read Single Self Token", "Read the information of a token via GET /api/my-tokens/:jti"),
    PredefinedPermission("token", "revoke-single-self", "Revoke Single Self Token", "Revoke user's own token via DELETE /api/my-tokens/:jti"),
    // Subjects for token
    ...
    PredefinedPermission("registration", "confirm-others", "Confirm Other's Registration", "Confirm a user registration via POST /api/registrations-others/{reg_id}/confirm"),
    // Check unique
    ...
    // User email updating
    PredefinedPermission("user-email-updating", "create", "Update Self Email", "Update self's email via POST /api/email-updating/"),
    PredefinedPermission("user-email-updating", "read", "Read Self Updating Email", "Query self's email updating via POST /api/email-updating/{update_id}"),
    PredefinedPermission("user-email-updating", "confirm", "Confirm Self Updating Email", "Confirm self's email updating via POST /api/email-updating/{update_id}/confirm"),
    PredefinedPermission("user-email-updating", "resend", "Resend Self Updating Email", "Resend self's email updating via POST /api/email-updating/{update_id}/resend"),
    PredefinedPermission("user-email-updating", "read-others", "Read User Updating Email", "Query user's email updating via POST /api/email-updating-others/{update_id}"),
    PredefinedPermission("user-email-updating", "confirm-others", "Confirm User Updating Email", "Confirm user's email updating via POST /api/email-updating-others/{update_id}/confirm"),
    PredefinedPermission("user-email-updating", "resend-others", "Resend User Updating Email", "Resend user's email updating via POST /api/email-updating-others/{update_id}/resend"),
];
...
pub const PREDEFINED_ROLES: &[PredefinedRole] = &[
    ...
    PredefinedRole("user-admin", &[
        ...
        ("user-email-updating", "read-others"),
        ("user-email-updating", "confirm-others"),
        ("user-email-updating", "resend-others"),
